# -*- coding: utf-8 -*-
"""Tuplas na prática.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1OUHja-CdOOc1NWvEzrUv24E-dDslXe90
...
t1=('lanche','refri','batata')
for i in t1:
  print('Temos no nosso cardapio: {}'.format(i))
print('Fim do Cardapio')
...
for indice, valor in enumerate(t1):
    print ('para indice = {} nós temos o valor = {}'. format(indice, valor))
...
t1 = ('Doce', 'Churrasco', 'Bala ', 'Tapioca', 'Pizza ', 'Feijão ',
      'Arroz ', 'Açaí ', 'Paçoca ', 'Acarajé', 'Pamonha', 'Dobradinha', 'Rapadura')
valor=t1(input('Qual comida você que?'))
pos = t1.index(valor)
print(valor)
print(sorted(t1))
...
for indice, valor in enumerate(t1):
    print ('Doce = {} nós temos o valor = {}'. format(indice, valor))
